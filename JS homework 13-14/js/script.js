...
//create an object with content
    ...
    confirm.addEventListener('click', function(e) {
        ...
        if (count == 4) {
            ...
            result.innerHTML = 'Поздравляем! Все Ваши ответы верны!';

            result.className = 'right_result'

        //if some answers wrong

        } else {

            result.innerHTML = 'К сожалению не все Ваши ответы верны!';

            underResult.innerHTML = 'Попробуйте еще раз.';

            result.className = 'wrong_result';
